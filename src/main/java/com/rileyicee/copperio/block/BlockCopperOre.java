...
public class BlockCopperOre extends ElementsCopperIO.ModElement {
	@GameRegistry.ObjectHolder("copperioport:copperore")
	public static final Block block = null;
	public BlockCopperOre(ElementsCopperIO instance) {
		super(instance, 4);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("copperioport:copperore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemRawCopper.block, (int) (2)));
		}
	}
}
