...
import com.rileyicee.copperio.procedure.ProcedureElecProcess;
import com.rileyicee.copperio.ElementsCopperIO;
import com.rileyicee.copperio.CopperIO;

@ElementsCopperIO.ModElement.Tag
public class GuiElectricProcess extends ElementsCopperIO.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiElectricProcess(ElementsCopperIO instance) {
		super(instance, 27);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("copperioport:textures/electricprocess.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Electricity Processor", 34, 11, -9737365);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 52, this.guiTop + 38, 70, 20, "Process"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureElecProcess.executeProcedure($_dependencies);
			}
		}
	}
