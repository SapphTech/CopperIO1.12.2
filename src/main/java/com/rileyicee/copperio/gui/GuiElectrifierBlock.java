...
package com.rileyicee.copperio.gui;
...
import com.rileyicee.copperio.procedure.ProcedureElectrifycopper;
import com.rileyicee.copperio.ElementsCopperIO;
import com.rileyicee.copperio.CopperIO;

@ElementsCopperIO.ModElement.Tag
public class GuiElectrifierBlock extends ElementsCopperIO.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiElectrifierBlock(ElementsCopperIO instance) {
		super(instance, 23);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 125, 30) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				CopperIO.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("copperioport:textures/electrifierblock.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Electrifier", 61, 11, -8684677);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 43, this.guiTop + 56, 90, 20, "Electrify"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			CopperIO.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureElectrifycopper.executeProcedure($_dependencies);
			}
		}
	}
